...
public class CreateProductFunctionalTest {
    ...
    void CreateProduct_isCorrect(ChromeDriver driver) throws Exception {
        driver.get(baseUrl);
        WebElement seeProductButton = driver.findElement(By.linkText("See Product List"));
        seeProductButton.click();
        ...
        assertEquals("New Product", productName);
