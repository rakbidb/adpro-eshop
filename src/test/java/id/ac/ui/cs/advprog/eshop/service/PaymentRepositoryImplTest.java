...
class PaymentServiceImplTest {
    ...
    void setUp() {
        ...
        Payment payment1 = new Payment("13652556-012a-4c07-b546-54eb1396d79b",
                PaymentMethods.VOUCHER.getValue(), orders.get(0), paymentData1);
        ...
        Payment payment2 = new Payment("13652556-012a-4c07-b546-54eb1396d79b",
                PaymentMethods.CASH_ON_DELIVERY.getValue(), orders.get(0), paymentData2);
    ...
    void testAddPayment() {
        ...
        Payment result = paymentService.addPayment(order, PaymentMethods.VOUCHER.getValue(), Map.of("voucherCode", "ESHOP1234ABC5678"));
